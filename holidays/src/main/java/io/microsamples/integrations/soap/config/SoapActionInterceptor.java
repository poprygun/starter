...
public class SoapActionInterceptor extends AbstractSoapInterceptor {
    ...
    public void handleMessage(SoapMessage message) throws Fault {
        ...
        String soapAction = interfaceInfoNameQName.getNamespaceURI() + operationQName.getLocalPart();
        reqHeaders.put(SoapBindingConstants.SOAP_ACTION, Arrays.asList(soapAction));

        reqHeaders.put(HttpHeaders.ACCEPT, Arrays.asList(MediaType.TEXT_XML_VALUE));
